          ...
          <div className="glass-card rounded-3xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                <p className="text-lg text-muted-foreground mb-8">{t.download.description}</p>

                <div className="flex flex-col sm:flex-row gap-4">
                  <a href="/scanap.apk" download>
                    <button className="flex items-center justify-center gap-2 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 glow-primary text-lg px-8 py-6 w-full sm:w-auto">
                  ...
                  <a href="/scanap.apk" download>
                    <button className="flex items-center justify-center gap-2 border border-border hover:bg-secondary text-lg px-8 py-6 rounded-xl w-full sm:w-auto">
